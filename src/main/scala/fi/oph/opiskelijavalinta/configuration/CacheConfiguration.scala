...
class CacheConfiguration {
  ...
  def cacheManager: CacheManager = {
    val cacheManager: CaffeineCacheManager = new CaffeineCacheManager(CacheConstants.KOUTA_HAKU_CACHE_NAME, CacheConstants.KOUTA_HAKUKOHDE_CACHE_NAME, CacheConstants.OAUTH2_CACHE_NAME)
