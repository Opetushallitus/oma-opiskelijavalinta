...
import fi.oph.opiskelijavalinta.model.{Aikataulu, Application, DateParam, HakemuksenTulos, Haku, Hakukohde, Hakutoive, Ilmoittautumistila, JonokohtainenTulos, OhjausparametritRaw, TranslatedName}
